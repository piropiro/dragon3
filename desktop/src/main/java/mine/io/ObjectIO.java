...
public class ObjectIO {
    ...
    public static Object read(String path) throws MineException {
        try (ObjectInputStream in = new ObjectInputStream(FileIO.INSTANCE.getInputStream(path))) {
    ...
    public static void write(String path, Object obj) throws MineException {
        try (ObjectOutputStream out = new ObjectOutputStream(FileIO.INSTANCE.getOutputStream(path))) {
